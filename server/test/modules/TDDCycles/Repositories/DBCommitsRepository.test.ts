...
describe("Save Commits", () => {
    ...
    testErrorHandling(() => repository.saveCommit('owner', 'repo', tddCycleDataObjectMock));
});
...
describe("Commit Exists", () => {
    ...
    testErrorHandling(() => repository.commitExists('owner', 'repo',  'sha'));
});
