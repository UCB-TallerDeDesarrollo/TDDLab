...
describe('executeQuery', () => {
  ...
  describe('registerUser', () => {
    it('should insert a new user into the database', async () => {
      const newUser = { email: 'newuser@example.com', groupid: 70, role: 'user',firstName: "Jane",lastName:"Smith" };
    ...
    it('should handle errors when inserting a new user', async () => {
      const newUser = { email: 'newuser@example.com', groupid: 70, role: 'user',firstName: "Jhon",lastName:"Doe" };
      const error = new Error('Database error');
