...
import AssignmentsController from "../controllers/assignments/assignmentController"; // Import your controller class
...
const assignmentController = new AssignmentsController(repository); // Pass the repository instance to the controller
