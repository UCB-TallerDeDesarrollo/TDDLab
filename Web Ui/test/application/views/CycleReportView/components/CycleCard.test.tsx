...
import { mockCommitInfoData } from '../../../../__ mocks __/dataTypeMocks/commitData';
...
describe('CycleCard component', () => {
  ...
  it('renders the commit message', () => {
    const { getByText } = render(<CycleCard commit={mockCommitInfoData} jobs={null}/>);
  ...
  it('renders the commit stats', () => {
    const { getByText } = render(<CycleCard commit={mockCommitInfoData} jobs={mockSuccessJobData} />);
  ...
  it('renders the card as failed', () => {
    const { getByText } = render(<CycleCard commit={mockCommitInfoData} jobs={mockFailedJobData}/>);
