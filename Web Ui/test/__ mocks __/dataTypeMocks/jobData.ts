import { JobDataObject } from "../../../src/domain/models/jobInterfaces";
  ...
  jobs: [
    {
      ...
      head_branch: "main",
      run_url: "https://api.github.com/repos/DwijanX/Bulls-and-Cows/actions/runs/3223439322",
      run_attempt: 1,
      ...
      html_url: "https://github.com/DwijanX/Bulls-and-Cows/actions/runs/3223439322/job/8812972390",
      status: "completed",
      conclusion: "success",
      ...
      check_run_url: "https://api.github.com/repos/DwijanX/Bulls-and-Cows/check-runs/8812972390",
