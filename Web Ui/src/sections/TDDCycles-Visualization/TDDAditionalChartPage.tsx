...
import TDDAditionalCharts from "./components/TDDAditionalChart";
...
function TDDAditionalChartPage({ port, role, teacher_id }: Readonly<CycleReportViewProps>) {
...
export default TDDAditionalChartPage;