  ...
  function getLineChart() {
    ...
    switch (optionSelected) {
      ...
      case "Ciclo de ejecución de pruebas": {
        const hardcodeLogTest = [
          {
            "numPassedTests": 1,
            "failedTests": 0,
            "numTotalTests": 1,
            "timestamp": 1758808425842,
            "success": true,
            "testId": 0
          },
          {
            "commitId": "855ad0f9735c0383b156887b2b55a796a177120c",
            "commitName": "Removing tdd_log.json from .gitignore",
            "commitTimestamp": 1758808528332,
            "testId": 0
          },
          {
            "commitId": "0e00f2bde22fdd38f1f97b4dd406b4ee77d2bec9",
            "commitName": "tdd_log.json modify",
            "commitTimestamp": 1758808579623,
            "testId": 1
          },
          {
            "numPassedTests": 1,
          ...
          },
          {
            ...
            "failedTests": 0,
            "numTotalTests": 1,
            "timestamp": 1758811616258,
            "success": true,
            "testId": 2
          },
          {
            "commitId": "49a7d7fb1632b210a05f3a16add0d3bbbdf21f60",
            "commitName": "test",
            "commitTimestamp": 1758811652329,
            "testId": 2
          },
          {
            "numPassedTests": 1,
          ...
          },
          {
            ...
            "failedTests": 0,
            "numTotalTests": 1,
            "timestamp": 1758812869485,
            "success": true,
            "testId": 3
          }
        ];
        const adapter = new CommitHistoryAdapter();
        const getTddLogUseCase = new GetTDDLogsUseCase(adapter);
        console.log(getTddLogUseCase.execute("luzhania", "TDD_project_test"))
        console.log(hardcodeLogTest)
        return <TDDCycleChart data={hardcodeLogTest} />;
        
        //return <TDDCycleChart data={getTddLogUseCase.execute("luzhania", "TDD_project_test")} />;
      }
